...
const formats = [
  {
    ...
    text: "A foundational session covering centring, cylinders, and trimming with generous tutor guidance.",
  },
  {
  ...
  },
  {
    ...
    text: "Tailored gatherings for friends, creative teams, or special occasions wanting a slower shared experience.",
  },
];
...
export const metadata: Metadata = {
  title: "Workshops",
  description:
    "Explore ceramics workshops at Kōwhai & Clay, from wheel throwing to hand-building and private studio sessions.",
};
    ...
    <main className="bg-limestone text-iron">
      <section className="relative h-[500px]">
        <img
          ...
          alt="Workshop hero scene with creative table setup and warm atmosphere"
        ...
        <div className="relative mx-auto flex h-full max-w-[1280px] flex-col justify-end px-5 py-12 text-limestone sm:px-8 lg:px-10 lg:py-16">
          ...
          <h1 className="mt-4 max-w-3xl font-heading text-5xl leading-[0.98] sm:text-6xl">
            Hands-on sessions designed for curiosity, confidence, and slower making.
          </h1>
      ...
      <section className="px-5 py-16 sm:px-8 lg:px-10 lg:py-24">
        <div className="mx-auto grid max-w-[1280px] gap-8 lg:grid-cols-2">
          <div className="rounded-[24px] bg-white/75 p-7 shadow-[0_8px_24px_rgba(40,36,33,0.06)]">
            <p className="font-mono text-xs uppercase tracking-[0.28em] text-umber">What to expect</p>
          ...
          <div className="rounded-[24px] bg-white/75 p-7 shadow-[0_8px_24px_rgba(40,36,33,0.06)]">
            <p className="font-mono text-xs uppercase tracking-[0.28em] text-umber">Who it suits</p>
            <p className="mt-4 text-lg leading-8 text-iron/76">
        ...
        <div className="mx-auto grid max-w-[1280px] gap-6 md:grid-cols-2">
          <div className="overflow-hidden rounded-[28px] shadow-[0_14px_40px_rgba(40,36,33,0.10)]">
            <img
              ...
              alt="Studio table setup for ceramics class with tools and materials ready"
          ...
          <div className="overflow-hidden rounded-[28px] shadow-[0_14px_40px_rgba(40,36,33,0.10)]">
            <img
              ...
              alt="Group creative workshop atmosphere in warm collaborative setting"
              className="h-[360px] w-full object-cover"
            />
          </div>
        </div>
      ...
      <section className="px-5 pb-20 sm:px-8 lg:px-10 lg:pb-28">
        <div className="mx-auto max-w-[1100px] rounded-[32px] bg-iron px-8 py-12 text-limestone shadow-[0_24px_80px_rgba(40,36,33,0.12)] sm:px-12 sm:py-14">
          ...
          <h2 className="mt-4 max-w-2xl font-heading text-4xl leading-tight sm:text-5xl">
            Reserve a place for a selected weekend workshop or plan a private studio gathering.
          </h2>
