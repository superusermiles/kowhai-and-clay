...
const posts = [
  {
    ...
    excerpt:
      "A look at the handmade ceramic pieces that stay on the table, move from room to room, and quietly become part of daily life.",
  ...
  },
  {
    ...
    excerpt:
      "How a few degrees in the kiln and a slower cooling cycle can alter the mood of a ceramic collection.",
...
export const metadata: Metadata = {
  title: "Ceramics Journal in Raglan | Kōwhai & Clay",
  description:
    "Read the Kōwhai & Clay journal for notes on handmade ceramics, interiors, material references, and ceramic process in Raglan, Waikato.",
  keywords: [
    "ceramics journal Raglan",
    "handmade pottery blog",
    "Raglan ceramics studio journal",
    "ceramic process notes",
    "Waikato ceramic studio blog",
  ],
  alternates: {
    canonical: "/journal/",
  },
        ...
        <div className="mx-auto max-w-[1280px]">
          ...
          <div className="max-w-[720px]">
            ...
            <h1 className="mt-4 font-heading text-5xl leading-[0.98] sm:text-6xl">
              Ceramics journal notes from the Raglan studio, the table, and the interiors that shape both.
            </h1>
          ...
          <section className="mt-12 grid gap-8 lg:grid-cols-[1.2fr_0.8fr]">
            <article className="overflow-hidden rounded-[32px] bg-white/80 shadow-[0_14px_40px_rgba(40,36,33,0.10)]">
              <img
                src={featured.image}
                alt="Featured ceramics journal image with coffee, pottery, and editorial tabletop styling"
            ...
            <div className="flex flex-col gap-6">
              {rest.map((post) => (
                <article key={post.title} className="grid gap-5 rounded-[24px] bg-white/80 p-5 shadow-[0_8px_24px_rgba(40,36,33,0.06)] sm:grid-cols-[220px_1fr]">
                  <img
                    src={post.image}
                    alt={`${post.title} journal image with warm interior and handmade ceramics context`}
